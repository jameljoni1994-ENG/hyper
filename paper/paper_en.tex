...
\caption{\textbf{Left:} normalized model cost \eqref{eq:Cu}; the bowl
is genuinely flat within a factor of ten of $u^\star$ (shaded band
$+5\%$). \textbf{Right:} excess cost of a factor-$\gamma$
misspecification for several $u^\star$; flatness collapses as
$\theta^\star\to1$.}
\label{fig:theory}
\end{figure}
